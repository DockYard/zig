...
// ZIR Library API — force-export all C-ABI symbols for libzap_compiler.a
...
comptime {
    ...
    _ = &api.zir_builder_emit_int;
    _ = &api.zir_builder_emit_int_typed;
    _ = &api.zir_builder_emit_float;
    _ = &api.zir_builder_emit_str;
    _ = &api.zir_builder_emit_bool;
    _ = &api.zir_builder_emit_void;
    _ = &api.zir_builder_emit_enum_literal;
    _ = &api.zir_builder_emit_binop;
    _ = &api.zir_builder_emit_negate;
    _ = &api.zir_builder_emit_bool_not;
    _ = &api.zir_builder_emit_call;
    _ = &api.zir_builder_emit_call_ref;
    _ = &api.zir_builder_emit_ret;
    _ = &api.zir_builder_emit_ret_void;
    _ = &api.zir_builder_emit_import;
    _ = &api.zir_builder_emit_field_val;
    _ = &api.zir_builder_emit_field_ptr;
    _ = &api.zir_builder_emit_store;
    _ = &api.zir_builder_emit_is_non_null;
    _ = &api.zir_builder_emit_optional_payload_unsafe;
    _ = &api.zir_builder_emit_optional_payload;
    _ = &api.zir_builder_emit_struct_init_anon;
    _ = &api.zir_builder_emit_as;
    _ = &api.zir_builder_emit_optional_type;
    _ = &api.zir_builder_emit_typeof;
    _ = &api.zir_builder_emit_if_else;
    _ = &api.zir_builder_emit_if_else_bodies;
    _ = &api.zir_builder_emit_cond_branch_with_bodies;
    _ = &api.zir_builder_emit_if_else_inline;
    _ = &api.zir_builder_set_call_modifier;
    _ = &api.zir_builder_emit_orelse;
    _ = &api.zir_builder_set_optional_return_type;
    _ = &api.zir_builder_emit_ret_null;
    _ = &api.zir_builder_emit_cond_return;
    _ = &api.zir_builder_emit_ret_error;
    _ = &api.zir_builder_set_error_union_return_type;
    ...
    _ = &api.zir_builder_emit_ensure_result_used;
    _ = &api.zir_builder_emit_dbg_stmt;
    _ = &api.zir_builder_emit_elem_val_imm;
    _ = &api.zir_builder_set_body_tracking;
    _ = &api.zir_builder_get_inst_count;
    _ = &api.zir_builder_begin_capture;
    _ = &api.zir_builder_end_capture;
    _ = &api.zir_builder_pop_body_inst;
    _ = &api.zir_builder_emit_try;
    _ = &api.zir_builder_emit_catch;
    _ = &api.zir_builder_emit_is_non_err;
    _ = &api.zir_builder_emit_err_union_payload_unsafe;
    _ = &api.zir_builder_set_generic_return_type;
    _ = &api.zir_builder_set_tuple_return_type;
    _ = &api.zir_builder_get_tuple_return_type;
